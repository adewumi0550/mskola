...
class SharedPreferenceHelper {
  ...
  static String userLevel = "USERLEVEL";

  //save data

  Future<bool> saveDepartment(String userDepartment) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString(userNameKey, userDepartment);
  }

  Future<bool> saveUserLevel(String userLevel) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString(userNameKey, userLevel);
  }
